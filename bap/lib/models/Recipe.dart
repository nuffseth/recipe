...
class Recipe extends Model {
  ...
  const Recipe._internal({required this.id, required idnum, required imageURL, required name, author, cuisine, diffulty, required servingsize, required preptime, required cookingtime, directions, createdAt, updatedAt}): _idnum = idnum, _imageURL = imageURL, _name = name, _author = author, _cuisine = cuisine, _diffulty = diffulty, _servingsize = servingsize, _preptime = preptime, _cookingtime = cookingtime, _directions = directions, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Recipe({String? id, required String idnum, required String imageURL, required String name, String? author, List<String>? cuisine, String? diffulty, required int servingsize, required String preptime, required String cookingtime, List<String>? directions}) {
    return Recipe._internal(
      ...
      directions: directions != null ? List<String>.unmodifiable(directions) : directions);
  }
  ...
  String toString() {
    ...
    buffer.write("Recipe {");
    buffer.write("id=" + "$id" + ", ");
    buffer.write("idnum=" + "$_idnum" + ", ");
    buffer.write("imageURL=" + "$_imageURL" + ", ");
    buffer.write("name=" + "$_name" + ", ");
    buffer.write("author=" + "$_author" + ", ");
    buffer.write("cuisine=" + (_cuisine != null ? _cuisine!.toString() : "null") + ", ");
    buffer.write("diffulty=" + "$_diffulty" + ", ");
    buffer.write("servingsize=" + (_servingsize != null ? _servingsize!.toString() : "null") + ", ");
    buffer.write("preptime=" + "$_preptime" + ", ");
    buffer.write("cookingtime=" + "$_cookingtime" + ", ");
    buffer.write("directions=" + (_directions != null ? _directions!.toString() : "null") + ", ");
  ...
  Recipe copyWith({String? id, String? idnum, String? imageURL, String? name, String? author, List<String>? cuisine, String? diffulty, int? servingsize, String? preptime, String? cookingtime, List<String>? directions}) {
    return Recipe._internal(
      id: id ?? this.id,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'idnum': _idnum, 'imageURL': _imageURL, 'name': _name, 'author': _author, 'cuisine': _cuisine, 'diffulty': _diffulty, 'servingsize': _servingsize, 'preptime': _preptime, 'cookingtime': _cookingtime, 'directions': _directions, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };

  static final QueryField ID = QueryField(fieldName: "recipe.id");
  static final QueryField IDNUM = QueryField(fieldName: "idnum");
